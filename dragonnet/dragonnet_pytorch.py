...
class DragonNet:
    ...
    def fit(self, X, treatment, y):
        ...
        # Reset gradienti accumulati da Adam prima di passare a SGD
        # Evita che il momentum di Adam destabilizzi SGD → NaN
    ...
    def _train_loop(self, optimizer, scheduler, loss_fn,
        ...
        for epoch in range(epochs):
            ...
            for X_batch, y_batch in train_loader:
                ...
                # Gradient clipping — evita esplosione dei gradienti (NaN)
                # Taglia i gradienti se la loro norma supera 1.0
